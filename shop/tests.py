...
class ProductViewTests(TestCase):
    def test_get_products(self):
        ...
        product_1 = Product.objects.create(title='Product 1', category=category, slug='product-1', image=uploaded)
        product_2 = Product.objects.create(title='Product 2', category=category, slug='product-2', image=uploaded)
